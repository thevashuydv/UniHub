            ...
            <div className="flex items-center">
              <div>
                <img
                  ...
                  src={`https://ui-avatars.com/api/?name=${currentUser?.displayName || 'Admin'}&background=0D8ABC&color=fff`}
                  alt=""
                />
              </div>
              <div className="ml-3">
                ...
                <Link to="/sign-in" className="text-sm font-medium text-gray-500 hover:text-gray-700">
                  Sign Out
                </Link>
              </div>
            </div>
